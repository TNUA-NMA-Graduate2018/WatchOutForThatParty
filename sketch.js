...
function newDrawing(data) {
  ...
  switch (scheduleMode) {
    case 0:
      image(img0, width/2 - 183, 140,366,150);
      break;
    case 1:
      image(img1, width/2 - 175, 140,350,150);
      break;
    case 2:
      image(img2, width/2 - 183, 140,366,150);
      break;
    case 3:
      image(img3, width/2 - 156, 140,312,176);
      break;
    case 4:
      image(img4, width/2 - 316, 140,632,150);
      break;
    case 5:
      image(img5, width/2 - 580, 140,1161,175);
      break;
    case 6:
      image(img6, width/2 - 192, 140,384,150);
      break;
    case 7:
      image(img7, width/2 - 224, 140,448,150);
      break;
  }
}
function draw() {
